...
define("DB_USERNAME", "isroil_notbuilder"); // Mysql baza nomi
define("DB_PASSWORD", "NotBuilder"); // Mysql baza paroli
define("DB_NAME", "isroil_notbuilder"); // Mysql baza nomi
...
if(!file_exists("sozlamalar/bot/bot.holati")){
file_put_contents("sozlamalar/bot/bot.holati","on");
}
if(!file_exists("sozlamalar/bot/limit.txt")){
file_put_contents("sozlamalar/bot/limit.txt","50");
...
$botholat=file_get_contents("sozlamalar/bot/bot.holat");
...
if($tx){
$kun = mysqli_fetch_assoc(mysqli_query($connect,"SELECT*FROM kunlik WHERE useri = '$botname'"))['kun'];
...
[['text'=>"⬆️ Avto yangilash"]],
[['text'=>"🎛 Tugmalar"],['text'=>"📑 Matnlar"]],
[['text'=>"📳 Bot holati"],['text'=>"🏆 Reyting"]],
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"@Create_MakerBot",'url'=>"t.me/Create_MakerBot"]],
]])
]);
}

if($tx=="⬆️ Avto yangilash"){
if(in_array($cid,$admin)){
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"⬆️ <b>Avto yangilash uchun bot turini tanlnag:</b>

1. KonstruktorBot   | 2. SpecialSMM Lite 
3. SpecialMember  | 4. AvtoNakrutka 
5. Obunachi Lite     | 6. ObunachiBot  
7. AutoNumber       | 8. GramAPIBot  
9. NamozVAQT       | 10. SarmoyaBot  
11. Reklamachi       | 12. PulBot Lite
13. VideoDown       | 14. TurfaBot",
'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"1",'callback_data'=>"buemas"],['text'=>"2",'callback_data'=>"avto=SpecialSMM Lite"],['text'=>"3",'callback_data'=>"avto=SpecialMember"],['text'=>"4",'callback_data'=>"avto=AvtoNakrutka"],['text'=>"5",'callback_data'=>"avto=Obunachi Lite"]],
[['text'=>"6",'callback_data'=>"avto=ObunachiBot"],['text'=>"7",'callback_data'=>"avto=AutoNumber"],['text'=>"8",'callback_data'=>"avto=GramAPIBot"],['text'=>"9",'callback_data'=>"avto=NamozVAQT"],['text'=>"10",'callback_data'=>"avto=SarmoyaBot"]],
[['text'=>"11",'callback_data'=>"avto=Reklamachi"],['text'=>"12",'callback_data'=>"avto=PulBot Lite"],['text'=>"13",'callback_data'=>"avto=VideoDown"],['text'=>"14",'callback_data'=>"avto=TurfaBot"]],
]])
]);
}}
...
'text'=>"🤷🏻‍♂ KonstruktorBot - avto yangilashni iloji yo'q!",
'show_alert'=>true,
]);
}
...
if($bots){
$tokeni = file_get_contents("foydalanuvchi/$ids/$exp/token.txt");
$turi = file_get_contents("foydalanuvchi/$ids/$exp/turi.txt");
if($turi=="$boturi"){
$kod =file_get_contents("botlar/$boturi.php");
$kod = str_replace("LITE_TOKEN", "$tokeni", $kod);
$kod = str_replace("LITE_ID", "$ids", $kod);
file_put_contents("foydalanuvchi/$ids/$exp/$boturi.php","$kod");
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tx/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/foydalanuvchi/$builder24/$botname/foydalanuvchi/$ids/$exp/$boturi.php"))->result;
if($get){
}}}else{
...
bot('sendMessage',[
'chat_id'=>$builder24,
'text'=>"<b>✅ $boturi - botlar yangilandi!</b>",
'parse_mode'=>"html",
]);
unlink("step/$cid.txt");
}

if($tx == "🏆 Reyting" and in_array($cid,$admin)){
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"<b>🏆 Reyting bo'yicha ma'lumotni ko'rish uchun tanlang</b>",
'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🏆 Hisob bo'yicha",'callback_data'=>"hisob"]],
[['text'=>"🏆 Referal bo'yicha",'callback_data'=>"dostlar"]],
]])
]);
}
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"◀️ Orqaga",'callback_data'=>"reyting"]],
]])
]);
}
...
if($tx == "📳 Bot holati" and in_array($cid,$admin)){
if($botholat=="off"){
$holat="O'chirilgan";
$holats="Yoqish";
}else{
...
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"<b>📳 Hozirgi holati:</b> $holat

Ushbu funksiya bot yaratishni o'chirib yoqish uchun qo'shilgan!",
'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"$holats",'callback_data'=>"holat"]],
]])
]);
}
...
if($data=="holat"){
if($botholat == "off"){
unlink("sozlamalar/bot/bot.holat");
bot('deleteMessage',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
]);
bot('sendMessage',[
'chat_id'=>$ccid,
'text'=>"<b>Bot yaratish yoqildi!</b>",
'parse_mode'=>"html",
'reply_markup'=>$admin1_menu,
]);
}else{
file_put_contents("sozlamalar/bot/bot.holat",'off');
bot('deleteMessage',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
]);
bot('sendMessage',[
'chat_id'=>$ccid,
'text'=>"<b>Bot yaratish o'chirildi!</b>",
'parse_mode'=>"html",
]);
}}
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"1",'callback_data'=>"addb=KonstruktorBot=$kat"],['text'=>"2",'callback_data'=>"addb=SpecialSMM Lite=$kat"],['text'=>"3",'callback_data'=>"addb=SpecialMember=$kat"],['text'=>"4",'callback_data'=>"addb=AvtoNakrutka=$kat"],['text'=>"5",'callback_data'=>"addb=Obunachi Lite=$kat"]],
[['text'=>"6",'callback_data'=>"addb=ObunachiBot=$kat"],['text'=>"7",'callback_data'=>"addb=AutoNumber=$kat"],['text'=>"8",'callback_data'=>"addb=GramAPIBot=$kat"],['text'=>"9",'callback_data'=>"addb=NamozVAQT=$kat"],['text'=>"10",'callback_data'=>"addb=SarmoyaBot=$kat"]],
[['text'=>"11",'callback_data'=>"addb=Reklamachi=$kat"],['text'=>"12",'callback_data'=>"addb=PulBot Lite=$kat"],['text'=>"13",'callback_data'=>"addb=VideoDown=$kat"],['text'=>"14",'callback_data'=>"addb=TurfaBot=$kat"]],
...
<b>20 kunlik to'lov</b> - $tolov20 $pul
...
$kod = str_replace("LITE_TOKEN", "$tokeni", $kod);
$kod = str_replace("LITE_ID", "$ccid", $kod);
file_put_contents("foydalanuvchi/$ccid/$ex/$turi.php","$kod");
file_put_contents("foydalanuvchi/$ccid/$ex/botholat.txt","activ");
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tokeni/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/foydalanuvchi/$builder24/$botname/foydalanuvchi/$ccid/$ex/$turi.php"))->result;
if($get){
if($p>=$narx){
bot('editMessageText',[
'chat_id'=>$ccid,
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"⚙. Qo'shimcha sozlamalar",'callback_data'=>"plus=$ex"]],
[['text'=>"💡. Yangilash",'callback_data'=>"up=$ex"],['text'=>"🗑. O'chirish",'callback_data'=>"del=$ex"]],
[['text'=>"🔄. Botni o'tkazish",'callback_data'=>"trans=$ex"]],
[['text'=>"🔐. Bot holat",'callback_data'=>"sozlash=$ex"],["text"=>"◀️. Orqaga","callback_data"=>"back=$ex"]],
]])
]);
}
...
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tokeni/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/bots/$botname/foydalanuvchi/$odam/$bot/$turi.php"))->result;
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🔑. Tokenni almashtirish",'callback_data'=>"token=$ex"]],
[['text'=>"🚀. Keshni tozalash",'callback_data'=>"kesh=$ex"]],
...
$ex=explode("=",$data)[1];
$holat=file_get_contents("foydalanuvchi/$ccid/$ex/botholat.txt");
if($holat == "activ"){
$holat = "Ishlamoqda";
}else{
$holat = "To'xtatilgan";
...
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"<b><i>🤖 Bot holati:</i></b> <i>$holat</i>",
'parse_mode'=>"html",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🔔. Ishlatish",'callback_data'=>"fl=$ex"],['text'=>"🔕. To'xtatish",'callback_data'=>"flz=$ex"]],
[['text'=>"◀️. Orqaga",'callback_data'=>"set=$ex"]],
]])
]);
}
...
$turi = file_get_contents("foydalanuvchi/$ccid/$ex/turi.txt");
$tokeni = file_get_contents("foydalanuvchi/$ccid/$ex/token.txt");
file_put_contents("botuser$ccid.txt","$ex");
file_put_contents("boturi$ccid.txt","$turi");
bot('editMessageText',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"⏱ <b>Yuklanmoqda...</b>",
...
file_put_contents("step/$ccid.txt","token");
}

if($userstep == "token"){
if($tx=="◀️ Orqaga"){
unlink("step/$cid.txt");
unlink("botuser$cid.txt");
unlink("boturi$cid.txt");
}else{
if(mb_stripos($tx, ":")!==false){
$bot=file_get_contents("botuser$cid.txt");
$boturi=file_get_contents("boturi$cid.txt");
file_put_contents("foydalanuvchi/$cid/$bot/token.txt","$tx");
$yengitoken=file_get_contents("foydalanuvchi/$cid/$bot/token.txt");
$kod = file_get_contents("botlar/$boturi.php");
$kod = str_replace("LITE_TOKEN", "$yengitoken", $kod);
$kod = str_replace("LITE_ID", "$cid", $kod);
file_put_contents("foydalanuvchi/$cid/$bot/$boturi.php","$kod");
file_put_contents("foydalanuvchi/$cid/$bot/botholat.txt","activ");
$get = json_decode(file_get_contents("https://api.telegram.org/bot$yengitoken/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/bots/$botname/foydalanuvchi/$cid/$bot/$boturi.php"))->result;
if($get){
bot('sendMessage',[
'chat_id'=>$cid,
...
date_default_timezone_set("asia/Tashkent");
$soat = date('H:i');
$bottoken = file_get_contents("foydalanuvchi/$ccid/$ex/token.txt");
$api0 = json_decode(file_get_contents("https://api.telegram.org/bot".$bottoken."/getwebhookinfo"));
$s = $api0->result->url;
if($soat){
$api1 = json_decode(file_get_contents("https://api.telegram.org/bot".$bottoken."/deletewebhook"));
$a1 = $api1->ok;
if($a1){
$api2 = json_decode(file_get_contents("https://api.telegram.org/bot".$bottoken."/getupdates?offset=-1"));
$a2 = $api2->ok;
if($a2){
$api3 = json_decode(file_get_contents("https://api.telegram.org/bot".$bottoken."/setwebhook?url=$s"));
$a3 = $api3->ok;
if($a3){
file_get_contents("https://api.telegram.org/bot".$bottoken."");
}}}}
bot('editmessagetext',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"◀️ Orqaga",'callback_data'=>"plus=$ex"]],
]])
]);
}
...
file_put_contents("foydalanuvchi/$ccid/$ex/$turi.php","$kod");
file_put_contents("foydalanuvchi/$ccid/$ex/botholat.txt","activ");
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tokeni/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/bots/$botname/foydalanuvchi/$ccid/$ex/$turi.php"))->result;
if($get){
bot('editMessageText',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"⏱ <b>Faollashmoqda...</b>",
'parse_mode'=>'html',
]);
bot('editMessageText',[
'chat_id'=>$ccid,
...
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"<b>✅ Botingiz muvaffaqiyatli faollashdi</b>",
'parse_mode'=>"html",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➡️ Botga o'tish",'url'=>"https://t.me/$ex"]],
[['text'=>"◀️ Orqaga",'callback_data'=>"sozlash=$ex"]],
]])
]);
}}

if(mb_stripos($data,"flz=")!==false){
$ex=explode("=",$data)[1];
$turi = file_get_contents("foydalanuvchi/$ccid/$ex/turi.txt");
$tokeni = file_get_contents("foydalanuvchi/$ccid/$ex/token.txt");
$kod = file_get_contents("botlar/$turi.php");
...
$kod = str_replace("LITE_ID", "$ccid", $kod);
file_put_contents("foydalanuvchi/$ccid/$ex/$turi.php","$kod");
file_put_contents("foydalanuvchi/$ccid/$ex/botholat.txt","none");
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tokeni/deletewebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/bots/$botname/foydalanuvchi/$ccid/$ex/$turi.php"))->result;
if($get){
bot('editMessageText',[
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"⏱ <b>Faolsizlanmoqda...</b>",
'parse_mode'=>'html',
]);
bot('editMessageText',[
'chat_id'=>$ccid,
...
'chat_id'=>$ccid,
'message_id'=>$cmid,
'text'=>"<b>✅ Botingiz muvaffaqiyatli faolsizlandi</b>",
'parse_mode'=>"html",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➡️ Botga o'tish",'url'=>"https://t.me/$ex"]],
...
bot('SendMessage',[
'chat_id'=>$cid,
'text'=>"<b>⛔️ Bot yaratish imkoniyati admin tomonidan o'chirilgan!</b>",
'parse_mode'=>'html',
]);
}else{
$kategoriya = file_get_contents("sozlamalar/bot/kategoriya.txt");
...
$kod = file_get_contents("botlar/$turi.php");
$kod = str_replace("LITE_TOKEN", "$tx", $kod);
$kod = str_replace("LITE_ID", "$fid", $kod);
...
if($turi=="KonstruktorBot"){
mkdir("foydalanuvchi/$cid/$botuser/mini");
file_put_contents("foydalanuvchi/$cid/$botuser/mini/SarmoyaBot.php",file_get_contents("mini/SarmoyaBot.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/ObunachiBot.php",file_get_contents("mini/ObunachiBot.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/SpecialSMM Lite.php",file_get_contents("mini/SpecialSMM Lite.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/PulBot Lite.php",file_get_contents("mini/PulBot Lite.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/TurfaBot.php",file_get_contents("mini/TurfaBot.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/GramAPIBot.php",file_get_contents("mini/GramAPIBot.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/AvtoNakrutka.php",file_get_contents("mini/AvtoNakrutka.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/Obunachi Lite.php",file_get_contents("mini/Obunachi Lite.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/Reklamachi.php",file_get_contents("mini/Reklamachi.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/SpecialMember.php",file_get_contents("mini/SpecialMember.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/NamozVAQT.php",file_get_contents("mini/NamozVAQT.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/AutoNumber.php",file_get_contents("mini/AutoNumber.php"));
file_put_contents("foydalanuvchi/$cid/$botuser/mini/VideoDown.php",file_get_contents("mini/VideoDown.php"));
}

$get = json_decode(file_get_contents("https://api.telegram.org/bot$tx/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/bots/$botname/foydalanuvchi/$cid/$botuser/$turi.php"))->result;
if($get){
$botuser = json_decode(file_get_contents("https://api.telegram.org/bot$tx/getme"))->result->username;
...
file_put_contents("foydalanuvchi/$cid/$botuser/admin.txt","$builder24");
file_put_contents("foydalanuvchi/$cid/$botuser/botnomi.txt","$botname");
